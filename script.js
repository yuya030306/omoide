...
const memberData = {
    1: {
        ...
        bio: `
            <p>いつも笑顔で元気をくれた柊弥。一緒に過ごした日々は宝物です！</p>
            <br>
            <p>学生時代は常にクラスのムードメーカーとして、みんなを笑顔にしてくれました。困っている人がいれば真っ先に手を差し伸べる優しさと、どんな時でも前向きに物事を考えるポジティブさは、私たちみんなの憧れでした。</p>
            <br>
            <p>文化祭では実行委員として大活躍し、体育祭ではリレーのアンカーとして見事な走りを見せてくれました。これからも明るく前向きに頑張ってください！</p>
        `
    },
    2: {
        name: '立花 信幸',
        ...
        bio: `
            <p>優しくて頼りになる信幸。困った時はいつも助けてくれました。</p>
            <br>
    ...
    3: {
        ...
        bio: `
            <p>ムードメーカーの泉里。君のおかげで毎日が楽しかった！</p>
            <br>
            <p>いつも周りを楽しませることを考えていた泉里。休み時間の即興コントや、修学旅行でのサプライズ企画など、君がいることで毎日が特別なものになっていました。</p>
        `
    },
    4: {
        name: '佐藤 大生',
        ...
        bio: `
            <p>しっかり者の大生。いつも的確なアドバイスをありがとう。</p>
            <br>
    ...
    5: {
        ...
        bio: `
            <p>努力家の哉斗。君の頑張りにいつも刺激をもらっていました。</p>
            <br>
    ...
    6: {
        ...
        bio: `
            <p>明るい新。その笑顔に何度も救われました。</p>
            <br>
            <p>まるで太陽のように明るく温かい新。落ち込んでいる時、その笑顔と前向きな言葉に何度も元気をもらいました。</p>
        `
    },
    7: {
        name: '塚越 涼介',
        ...
        bio: `
            <p>クールな涼介。でも本当は優しいって知ってるよ！</p>
            <br>
            <p>普段はクールで寡黙だけど、実はとても優しくて思いやりのある涼介。困っている人を見つけると、さりげなく手を差し伸べる姿が印象的でした。</p>
        `
    },
    8: {
        name: '林 祐哉',
        ...
        bio: `
            <p>天真爛漫な祐哉。君といると自然と笑顔になれました。</p>
            <br>
            <p>いつも元気いっぱいで、周りを明るくしてくれた祐哉。その純粋で真っ直ぐな性格は、みんなの癒しでした。一緒にいるだけで自然と笑顔になれる、そんな素敵な存在でした。</p>
        `
    }
};
